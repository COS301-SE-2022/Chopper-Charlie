  ...
  return (
    <div>
      <div id="Searchbar">
        ...
        <button id="viewList">
          <ViewListOutlinedIcon id="listOptionactive" />
        </button>
          ...
          <div className="center">
            <div id="HomeContentList">
              <div id="MediaBlockList">
                ...
                >
                  <button
                    id="DownloadButtonList"
                    onClick={() => downData(thedata)}
                  >
                    <CloudDownloadRoundedIcon sx={{ fontSize: 23 }} />
                    Download
                  </button>
                </a>
                <button
                  id="AnalyseButtonList"
                ...
                &nbsp;
                <button id="DeleteButtonList" onClick={() => delData(thedata)}>
