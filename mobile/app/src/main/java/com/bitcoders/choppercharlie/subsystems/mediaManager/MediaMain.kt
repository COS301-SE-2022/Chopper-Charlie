...
*/
class MediaMain : AppCompatActivity(), View.OnClickListener {
    ...
    */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_media) //inflating the activity_media layout as the activity's view
        ...
        */
        photoStorageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
        videoStorageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
    ...
    private fun initUI() {
        ...
        val layoutManager = LinearLayoutManager(this@MediaMain, RecyclerView.VERTICAL, false)
        ...
        mLoadingDialog = ProgressDialog(this@MediaMain)
        ...
        mDownloadDialog = ProgressDialog(this@MediaMain)
    ...
    private fun setResultToToast(result: String) {
        runOnUiThread {
            Toast.makeText(this@MediaMain, result, Toast.LENGTH_SHORT).show()
        }
    }
